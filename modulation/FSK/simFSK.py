...
# Title: FrequencyShiftKeying
# Author: Emman Estallo
...
class simFSK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FrequencyShiftKeying")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FrequencyShiftKeying")
        ...
        self.settings = Qt.QSettings("GNU Radio", "simFSK")
        ...
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 50, 1, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 5000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 50, -1, 1, 0)
...
def main(top_block_cls=simFSK, options=None):
